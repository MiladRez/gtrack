...
export default function TodaysSessionPage() {
	...
	const AddExerciseDialog = ({exerciseType}: {exerciseType: string}) => {
		return (
			<Dialog>
				<DropdownMenu>
					<DropdownMenuTrigger className="px-6 py-4 bg-slate-900 border border-slate-700 rounded-lg sm:mt-20">Add {exerciseType} Exercise</DropdownMenuTrigger>
					<DropdownMenuContent>
						{getSessionExercises(exerciseType)
	...
	return (
		<div className="w-screen flex justify-center">
			<div className="max-w-(--breakpoint-md) w-full flex flex-col items-center gap-12 mx-4">
				...
				<h2 className="scroll-m-20 mt-20 border-b pb-2 text-3xl font-semibold tracking-tight first:mt-0">Today's Session</h2>
				<AddExerciseDialog exerciseType="Push" />
				<AddExerciseDialog exerciseType="Pull" />
				<AddExerciseDialog exerciseType="Legs" />
